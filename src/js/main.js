const tabBtns = document.querySelectorAll('.bankrot__tabs-item')
const tabsItem = document.querySelectorAll('.bankrot__content')
...
tabBtns.forEach(item => {
    item.addEventListener('click', () => {
        ...
        if (!currentBtn.classList.contains('active')) {
            ...
            tabsItem.forEach(i => i.classList.remove('active'))
